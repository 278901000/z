	...
	public abstract class TopFieldCollector : TopDocsCollector<Entry>
	{
		...
		*/
		private class OneComparatorScoringNoMaxScoreCollector : OneComparatorNonScoringCollector
		{
			...
			internal void UpdateBottom(int doc, double score)
			{
				bottom.Doc = docBase + doc;
				bottom.Score = score;
				bottom = pq.UpdateTop();
		...
		*/
		internal double maxScore = System.Double.NaN;
		...
		internal void  Add(int slot, int doc, double score)
		{
