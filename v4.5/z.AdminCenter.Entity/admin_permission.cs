...
{
	[Serializable, CustomData(ConnectionName = "AdminCenterDB"), Table("admin_permission")]
	public partial class admin_permission : EntityBase
    {
		/// <summary>
		///
		/// </summary>
		[Key, Column("AdminPermissionId")]
		public virtual Int32 AdminPermissionId
        {
            get;
            set;
        }
