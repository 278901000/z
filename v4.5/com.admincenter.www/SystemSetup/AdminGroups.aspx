<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminGroups.aspx.cs" Inherits="com.admincenter.www.SystemSetup.AdminGroups" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box purple">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-table"></i>管理员组列表
                                </div>
                                <div class="actions">
                                    <a href="/SystemSetup/AdminGroupOperate.aspx?type=add" class="btn blue">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_2">
                                    ...
                                    <tbody>
                                        <% foreach (var item in g_AdminGroups.Rows)
                                           {
                                        %>
                                        <tr class="odd gradeX">
                                            <td>
                                                <input name="chkPrimaryKey" type="checkbox" class="checkboxes" value="<%= item.AdminGroupId %>" />
                                            </td>
                                            <td><%= item.Name %></td>
                                            <td><%= item.Type == 0 ? "超级管理员" : "普通管理员" %></td>
                                            <td>
                                            ...
                                            <td>
                                                <a href="/SystemSetup/AdminGroupOperate.aspx?type=update&id=<%= item.AdminGroupId %><%= string.IsNullOrEmpty(Request.QueryString.ToString()) ? "" : ("&custom=" + Server.UrlEncode(Request.QueryString.ToString())) %>" class="btn default btn-xs purple">
                                ...
                                <% if (g_AdminGroups.TotalPages > 1)
                                   {
                                       int intStart = (g_AdminGroups.PageIndex - 1) * g_AdminGroups.PageSize + 1;
                                       int intEnd = g_AdminGroups.PageIndex * g_AdminGroups.PageSize;
                                       if (intEnd > g_AdminGroups.TotalCount)
                                       {
                                           intEnd = g_AdminGroups.TotalCount;
                                       }
                                %>
                                <div class="row">
                                    <div class="col-md-5 col-sm-12">
                                        <div class="dataTables_info" id="sample_2_info">Showing <%= intStart %> to <%= intEnd %> of <%= g_AdminGroups.TotalCount %> entries</div>
                                    </div>
                                    <div class="col-md-7 col-sm-12">
                                        <div class="dataTables_paginate paging_bootstrap">
                                            <%= GetPager<admin_group>(g_AdminGroups) %>
                                        </div>
                                    </div>
                                </div>
                                <% } %>
        ...
        $(document).ready(function () {
            ...
            $('input[name="chkDisabled"]').on('switch-change', function (e, data) {
                ...
                bootbox.confirm("你确定要" + disableText + "当前项吗?", function (result) {
                    if (result == true) {
                        $.ajax({
                            url: "/SystemSetup/AdminGroups.aspx",
                            type: "POST",
