<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminUsers.aspx.cs" Inherits="com.admincenter.www.SystemSetup.AdminUsers" %>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box purple">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-table"></i>管理员用户列表
                                </div>
                                <div class="actions">
                                    <a href="/SystemSetup/AdminUserOperate.aspx?type=add" class="btn blue">
                            ...
                            <div class="portlet-body">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="sample_2">
                                    ...
                                    <tbody>
                                        <% foreach (var item in g_AdminUsers.Rows)
                                           {
                                        %>
                                        <tr class="odd gradeX">
                                            <td>
                                                <input name="chkPrimaryKey" type="checkbox" class="checkboxes" value="<%= item.AdminUserId %>" />
                                            </td>
                                            ...
                                            <td>
                                                <a href="/SystemSetup/AdminUserOperate.aspx?type=update&id=<%= item.AdminUserId %><%= string.IsNullOrEmpty(Request.QueryString.ToString()) ? "" : ("&custom=" + Server.UrlEncode(Request.QueryString.ToString())) %>" class="btn default btn-xs purple">
                                ...
                                <% if (g_AdminUsers.TotalPages > 1)
                                   {
                                       int intStart = (g_AdminUsers.PageIndex - 1) * g_AdminUsers.PageSize + 1;
                                       int intEnd = g_AdminUsers.PageIndex * g_AdminUsers.PageSize;
                                       if (intEnd > g_AdminUsers.TotalCount)
                                       {
                                           intEnd = g_AdminUsers.TotalCount;
                                       }
                                %>
                                <div class="row">
                                    <div class="col-md-5 col-sm-12">
                                        <div class="dataTables_info" id="sample_2_info">Showing <%= intStart %> to <%= intEnd %> of <%= g_AdminUsers.TotalCount %> entries</div>
                                    </div>
                                    <div class="col-md-7 col-sm-12">
                                        <div class="dataTables_paginate paging_bootstrap">
                                            <%= GetPager<admin_user>(g_AdminUsers) %>
                                        </div>
                                    </div>
                                </div>
                                <% } %>
        ...
        $(document).ready(function () {
            ...
            $('input[name="chkDisabled"]').on('switch-change', function (e, data) {
                ...
                bootbox.confirm("你确定要" + disableText + "当前项吗?", function (result) {
                    if (result == true) {
                        $.ajax({
                            url: "/SystemSetup/AdminUsers.aspx",
                            type: "POST",
