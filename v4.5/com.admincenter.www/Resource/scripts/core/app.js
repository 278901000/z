...
**/
var App = function () {
	var spinner = (typeof adminCenterDomain !== 'undefined' ? adminCenterDomain : '') + '/Resource/img/loading-spinner-grey.gif';
    ...
    var handleSidebarToggler = function () {
        var viewport = _getViewPort();
        if ($.cookie && ($.cookie('sidebar_closed') === '1' || $.cookie('sidebar_closed') == null) && viewport.width >= 992) {
    ...
    return {
        ...
        blockUI: function (options) {
            ...
            var html = '';
            if (options.iconOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img style="" src="'+ spinner+'" align=""></div>';
            } else if (options.textOnly) {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            } else {
                html = '<div class="loading-message ' + (options.boxed ? 'loading-message-boxed' : '') + '"><img style="" src="'+ spinner+'" align=""><span>&nbsp;&nbsp;' + (options.message ? options.message : 'LOADING...') + '</span></div>';
            }
        ...
        startPageLoading: function (message) {
            $('.page-loading').remove();
            $('body').append('<div class="page-loading"><img src="'+ spinner +'"/>&nbsp;&nbsp;<span>' + (message ? message : 'Loading...') + '</span></div>');
        },
